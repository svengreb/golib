...
- **Ensure the enhancement has not already been reported by using the [GitHub Issues search](https://github.com/svengreb/golib/issues)** — check if this enhancement has already been suggested. If it has **and the issue is still open**, add your additions as comment to the existing issue instead of opening a new one. If you find a closed issue that seems to be similar to this one, include a link to the original issue in the [metadata head](#metadata-head) section of this issue.
- **Check if the enhancement has already been implemented** — use the [latest version](https://github.com/svengreb/golib/releases/latest) and [`main`](https://github.com/svengreb/golib/tree/main) branch to ensure that the feature or improvement has not already been added.
...
Provide a [MCVE - The Minimal, Complete, and Verifiable Example](https://github.com/svengreb/golib/blob/main/CONTRIBUTING.md#mcve)
