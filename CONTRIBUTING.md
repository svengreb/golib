...
Thanks for contributing to golib!

This is a set of guidelines for contributing to golib. Please take a moment to review this document in order to make the contribution process easy and effective for everyone involved.

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open source project. In return, they should reciprocate that respect in addressing your issue, assessing changes, and helping you finalize your pull requests.

As for everything else in the project, the contributions to golib are governed by our [Code of Conduct][gh-coc]. By participating, you are expected to uphold this code. Please report unacceptable behavior at support@svengreb.de or directly to one of the core team members via [email][gh-mailmap].

## Getting Started

golib is an open source project and we love to receive contributions from the community! There are many ways to contribute, from [writing- and improving documentation and tutorials](#documentations), [reporting bugs](#bug-reports), [submitting enhancement suggestions](#enhancement-suggestions) which can be incorporated into this project by [submitting a pull request](#pull-requests).
...
A bug is a _demonstrable problem_ that is caused by the code in the repository. This section guides you through submitting a bug report for golib. Following these guidelines helps maintainers and the community understand your report, reproduce the behavior and find related reports.
...
- **Did the problem start happening recently** e.g. after updating to a new version of golib or was this always a problem?
  - If the problem started happening recently, **can you reproduce the problem in an older version of golib?**
...
- **Explain why this enhancement would be useful** to most golib users.
...
golib's documentation consists of guides, which helps users to learn about the project.
...
golib uses the [GitHub Flow][ghg-flow] branching model. The repository consists of the `main` core branch with an infinite development lifecycle. The source code of `HEAD` in this branch contains the latest development state and reflects all tagged release versions.
...
We're always looking for more opinions on discussions in issues and pull request reviews which is a good opportunity to influence the future direction of golib.
...
golib adheres to the [Arctic Ice Studio JavaScript Style Guide][gh-styleguide-javascript].

[![][gh-styleguide-javascript-badge]][gh-styleguide-javascript]

### Markdown Style Guide

golib adheres to the [Arctic Ice Studio Markdown Style Guide][gh-styleguide-markdown].
...
golib adheres to the [Arctic Ice Studio Git Style Guide][gh-styleguide-git].
...
[gh-branch-main]: https://github.com/svengreb/golib/tree/main
[gh-changelog]: https://github.com/svengreb/golib/blob/main/CHANGELOG.md
[gh-coc]: https://github.com/svengreb/golib/blob/main/CODE_OF_CONDUCT.md
[gh-gist]: https://gist.github.com
[gh-issues-label-question]: https://github.com/svengreb/golib/labels/type-question
[gh-issues-template-bug]: https://github.com/svengreb/golib/blob/main/.github/ISSUE_TEMPLATE/bugs.md
[gh-issues-template-enhancement]: https://github.com/svengreb/golib/blob/main/.github/ISSUE_TEMPLATE/enhancement.md
[gh-issues-template-pr]: https://github.com/svengreb/golib/blob/main/.github/PULL_REQUEST_TEMPLATE.md
[gh-issues-templates]: https://github.com/svengreb/golib/issues/new/choose
[gh-issues]: https://github.com/svengreb/golib/issues
[gh-mailmap]: https://github.com/svengreb/golib/blob/main/.mailmap
[gh-pr]: https://github.com/svengreb/golib/pulls
[gh-releases-latest]: https://github.com/svengreb/golib/releases/latest
